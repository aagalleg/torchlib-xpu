...
//   Template Path: FBGEMM/fbgemm_gpu/codegen/training/backward/embedding_backward_split_host_template.cpp 
//   Generated File: fbgemm_gpu/_skbuild/linux-x86_64-3.10/cmake-build/gen_embedding_backward_split_dense.cpp
//
// ARCHITECTURE OVERVIEW:
//   - Main entry: split_embedding_lookup_dense_function (Host Wrapper)
//   - Route 1: VBE (Variable Batch Embedding) - B_offsets present [NOT IMPLEMENTED]
    ...
    static torch::autograd::variable_list forward(
        ...
        static auto embedding_forward_op =
            torch::Dispatcher::singleton()
                .findSchemaOrThrow("fbgemm::dense_embedding_nobag_forward_unweighted_xpu", "")
                .typed<decltype(dense_embedding_nobag_forward_unweighted_xpu)>();
...
//   else                                          → Pooled Route [NOT IMPLEMENTED]
//
...
at::Tensor split_embedding_lookup_dense_function_xpu(
    ...
    if (B_offsets.has_value()) {
        ...
        TORCH_CHECK(false, "dense_embedding_codegen_lookup_function with B_offsets is not implemented yet.");
      ...
      return SplitNoBagLookupFunctionDenseOpXPU::apply(
        ...
        TORCH_CHECK(false, "dense_embedding_codegen_lookup_function is not implemented yet for SplitLookupFunction_dense_Op.");

    }
}

TORCH_LIBRARY_IMPL(fbgemm, AutogradXPU, m) {
    m.impl("dense_embedding_codegen_lookup_function", &split_embedding_lookup_dense_function_xpu);
}
