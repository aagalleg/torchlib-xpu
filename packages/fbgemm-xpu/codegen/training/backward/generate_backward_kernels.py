#!/usr/bin/env python3
"""
Script to generate SYCL backward kernels from Jinja2 template.

This script demonstrates how to use the embedding_backward_split_kernel_warp_template.sycl
template to generate both dense and split backward kernel variants.

Usage:
    python generate_backward_kernels.py [--output-dir <dir>]

Example:
    python generate_backward_kernels.py --output-dir ../../../src/fbgemm_xpu/sycl_kernels/
"""
...
def main():
    ...
    host_sycl_template_file = 'embedding_backward_nobag_unweighted_host_template.sycl'
    pt2_template_dir = template_dir.parent / "pt2"
    pt2_sycl_template_file = 'embedding_forward_nobag_unweighted_pt2_wrapper_template.sycl'
    ...
    # Define output variants: each produces a .h header and a .sycl implementation
    output_dir = Path(args.output_dir)
    variants = [
        {
            'dense': True,
            'sycl_filename': 'gen_embedding_backward_dense_unweighted_nobag_kernels.h',
            'host_sycl_filename': 'gen_embedding_backward_dense_unweighted_nobag_host.sycl',
        ...
        },
        {
            ...
            'host_sycl_filename': 'gen_embedding_backward_rowwise_adagrad_split_unweighted_nobag_host.sycl',
            'pt2_fwd_sycl_filename': 'gen_embedding_forward_split_nobag_unweighted_pt2_xpu_wrapper.sycl',
            'pt2_bwd_sycl_filename': 'gen_embedding_backward_split_rowwise_adagrad_nobag_unweighted_pt2_xpu_wrapper.sycl',
    ...
    if not args.dry_run:
        ...
        print("\nNext steps:")
        print("  1. Include generated .h and .sycl files in your CMakeLists.txt")
...
def validate_template():
    ...
    templates = [
        ...
        'embedding_backward_split_kernel_warp_template.sycl',
    ]
