...
class TestPermute1DSparseData(TestCase):
    ...
    def _test_correctness(self, device: str, lengths_dtype: torch.dtype, 
        ...
        result = fbgemm.ops.permute_1D_sparse_data(permute, lengths, indices, weights)
        ...
        result = fbgemm.ops.permute_1D_sparse_data(permute_id, lengths_id, indices_id, weights_id)
        ...
        result = fbgemm.ops.permute_1D_sparse_data(permute_rev, lengths_rev, indices_rev, weights_rev)
    ...
    def _test_edge_cases(self, device: str):
        ...
        result = fbgemm.ops.permute_1D_sparse_data(permute_empty, lengths, indices)
        ...
        result = fbgemm.ops.permute_1D_sparse_data(permute_single, lengths_single, indices_single)
        ...
        result = fbgemm.ops.permute_1D_sparse_data(permute_zero, lengths_zero, indices_zero)
        ...
        result = fbgemm.ops.permute_1D_sparse_data(permute_dup, lengths_dup, indices_dup)
    ...
    def _test_with_permuted_lengths_sum(self, device: str):
        ...
        result = fbgemm.ops.permute_1D_sparse_data(
    ...
    def test_cpu_xpu_consistency(self):
        ...
        # Run on CPU
        result_cpu = fbgemm.ops.permute_1D_sparse_data(
        ...
        result_xpu = fbgemm.ops.permute_1D_sparse_data(
...
class TestPermute1DSparseDataDLRMScale(TestCase):
    ...
    def test_large_segments(self):
        ...
        result = fbgemm.ops.permute_1D_sparse_data(permute, lengths, indices)
        expected = compute_reference_permute_1d_sparse_data(permute, lengths, indices)
