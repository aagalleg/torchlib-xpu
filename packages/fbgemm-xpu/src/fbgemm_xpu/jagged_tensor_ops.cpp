...
////////////////////////////////////////////////////////////////////////////////
//
// Host-side operators, autograd functions and XPU dispatch registrations for the
// jagged tensor family (dense_to_jagged, jagged_to_padded_dense,
// jagged_dense_elementwise_add_jagged_output and jagged_2d_to_dense). Device
// kernels are launched through the helpers declared in
...
//   CUDA dispatch registration for jagged_2d_to_dense:
...
//     -> jagged_dense_elementwise_add_jagged_output (jagged_tensor_ops_autograd.cpp)
