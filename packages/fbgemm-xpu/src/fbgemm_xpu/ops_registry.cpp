...
TORCH_LIBRARY_FRAGMENT(fbgemm, m) {
    ...
    if (!utils::torch::schemaExists("fbgemm::dense_embedding_codegen_lookup_function")) {
    ...
    if (!utils::torch::schemaExists("fbgemm::dense_embedding_nobag_forward_unweighted_xpu")) {
        m.def("dense_embedding_nobag_forward_unweighted_xpu("
            "    Tensor dev_weights, "
            "    Tensor weights_offsets, "
            "    SymInt D, "
            "    Tensor indices, "
    ...
    if (!utils::torch::schemaExists("fbgemm::split_embedding_codegen_lookup_rowwise_adagrad_function_pt2")){
        m.def("split_embedding_codegen_lookup_rowwise_adagrad_function_pt2("
    ...
    if (!utils::torch::schemaExists("fbgemm::split_embedding_nobag_forward_unweighted_xpu")) {
        m.def("split_embedding_nobag_forward_unweighted_xpu("
            "    Tensor dev_weights, "
            "    Tensor uvm_weights, "
            "    Tensor lxu_cache_weights, "
            "    Tensor weights_placements, "
