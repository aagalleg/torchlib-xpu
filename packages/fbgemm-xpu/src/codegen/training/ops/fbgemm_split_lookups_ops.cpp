...
//     CUDA File: fbgemm_gpu/_skbuild/linux-x86_64-3.10/cmake-build/gen_embedding_split_rowwise_adagrad_pt2_autograd.cpp
//
// DESCRIPTION:
...
//   CUDA File: fbgemm_gpu/_skbuild/linux-x86_64-3.10/cmake-build/gen_embedding_split_rowwise_adagrad_pt2_autograd.cpp
//   CUDA Template: fbgemm_gpu/codegen/training/pt2/embedding_split_host_pt2_autograd_template.cpp
//
// DESCRIPTION:
...
//
// DESCRIPTION:
//   Main entry point for split embedding lookups with rowwise Adagrad optimizer.
//   Handles both pooled (bag) and non-pooled (nobag/sequence) embedding lookups.
//   Routes to appropriate autograd function based on pooling_mode parameter.
//
...
//
// PYTORCH DISPATCHER:
//   Registered as: fbgemm::split_embedding_codegen_lookup_rowwise_adagrad_function_pt2
...
TORCH_LIBRARY_IMPL(fbgemm, AutogradXPU, m) {
    m.impl("split_embedding_codegen_lookup_rowwise_adagrad_function_pt2", &split_embedding_codegen_lookup_rowwise_adagrad_function_pt2_xpu);
}
